...
public enum ItemStats {
	LIGHT("bullet.png", 0.3f, 6f, 7f, 2.5f), MEDIUM("bullet.png", 0.3f, 8f, 7f, 2f), HEAVY(
			...
			"bullet.png", 0.7f, 5f, 5f, 0.75f), LEVEL3_GUN("bullet.png", 1.25f, 11f, 6f, 0.75f), LEVEL3_GUN2(
			"bullet.png", 0.7f, 17.5f, 3f, 0.75f), HORSE("level3/benign.png", 2f, 15f, 5f, 0.75f), LEVEL4_GUN(
